...
const Contact = () => {
  ...
  return (
    <section id="contact" className='c-space my-20'>
      <div className='relative xl:min-h-screen h-full flex items-center justify-center flex-col'>
        <img src="/assets/terminal.png" alt="terminal-bg" className='absolute inset-0 h-full w-full object-contain xl:flex hidden' />
